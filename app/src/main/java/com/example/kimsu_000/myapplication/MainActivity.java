package com.example.kimsu_000.myapplication;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEtIndex = (EditText) findViewById(R.id.et_text);
        mBtInsert = (Button) findViewById(R.id.bt_insert);
        mBtRead = (Button) findViewById(R.id.bt_read);
        mBtDelete = (Button) findViewById(R.id.Del);
        mBtSort = (Button) findViewById(R.id.Sor);
        mBtUpdate = (Button) findViewById(R.id.Upd);
        ...
        mBtDelete.setOnClickListener(new View.OnClickListener(){
                                        public void onClick(View v){
                                            String index = mEtName.getText().toString();
